...
const ExchangeWrapper = props => {
    ...
    return (
        <ReactGridLayout
            ...
            cols={cols}
            draggableHandle=".cr-table-header__content, .pg-exchange-screen__tab-panel, .draggable-container"
            rowHeight={14}
            layouts={layouts}
...
class Exchange extends React.Component<Props, StateProps> {
    ...
    public componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.currentMarket) {
            ...
            if (marketNotMatched) {
                history.replace(`/exchange/${nextProps.currentMarket.id}`);
        ...
        if (nextProps.currentMarket && nextProps.tickers) {
            this.setExchangeTitle(nextProps.currentMarket, nextProps.tickers);
        }
    }
    ...
    public render() {
        ...
        return (
            <div className={'pg-exchange-screen'}>
                <div className={'pg-exchange-wrap'}>
                    <ToolBar/>
    ...
    private setExchangeTitle = (market: Market, tickers: ReduxProps['tickers']) => {
...
export const ExchangeScreen = compose(
    injectIntl,
    withRouter,
    connect(mapStateToProps, mapDispatchToProps),
)(Exchange) as React.ComponentClass;
